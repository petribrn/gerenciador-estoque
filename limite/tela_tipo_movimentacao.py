...
class TelaTipoMovimentacao(Tela):
    ...
    def init_components(self):
        ...
        layout = [
                    ...
                    [sg.Submit("Adicionar", key=1)],
                    [sg.Submit("Remover", key=2)],
                    [sg.Cancel("Retornar", key=3, button_color='gray'), sg.Cancel('Sair', key=0, button_color='red')]
                ]
    ...
    def open(self):
        ...
        if botao == None or botao == sg.WIN_CLOSED or botao == 3:
            super().close()
        return botao
